          ...
          <div className="w-full max-w-md rounded-3xl border border-border bg-card p-6 shadow-2xl text-card-foreground">
            <div className="flex items-center justify-between border-b border-border pb-3 mb-4">
              <div className="flex items-center gap-2.5">
                ...
                <h3 className="text-lg font-extrabold">Choose Your ZipRide Role</h3>
              </div>
              <button
                type="button"
            ...
            <p className="text-xs font-medium text-muted-foreground mb-5">
              Select how you want to continue with Google into ZipRide:
            </p>
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-extrabold text-foreground text-sm">Rider Account (Passenger)</p>
                    <p className="text-xs text-muted-foreground mt-0.5">
                      Book rides, view fare calculations, track live drivers & wallet details
                    </p>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-extrabold text-foreground text-sm">Driver Account (Partner)</p>
                    <p className="text-xs text-muted-foreground mt-0.5">
                      Accept ride requests, manage earnings, trip history & vehicle details
                    </p>
                  </div>
                </div>
              </button>
